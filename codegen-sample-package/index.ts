export type { IncomingData } from "./src/Fabric/specs/v1/CodegenArkTSNativeComponent";
export type { IncomingDataCAPI, SupportedCommandArgs } from "./src/Fabric/specs/v2/CodegenCApiNativeComponent";

export type { GeneratedSampleComponentArkTSRef } from "./src/Fabric/IndexArkTS";
export type { GeneratedSampleComponentCAPIRef } from "./src/Fabric/IndexCAPI";
