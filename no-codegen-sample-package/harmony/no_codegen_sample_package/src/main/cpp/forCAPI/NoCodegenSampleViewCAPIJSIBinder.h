...
namespace rnoh {
class NoCodegenSampleViewCAPIJSIBinder : public ViewComponentJSIBinder {
  protected:
    ...
    facebook::jsi::Object createDirectEventTypes(facebook::jsi::Runtime &rt) override {
        ...
        events.setProperty(rt, "topReceivedCommandArgs", createDirectEvent(rt, "onReceivedCommandArgs"));
        return events;
    }
};
} // namespace rnoh
